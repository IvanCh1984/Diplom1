                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            ...
                            <?php if ($user["status"] == 'Онлайн') {
                                ...
                                <span class="status status-<?php echo $status; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('upload/<?php echo $user['image']; ?>'); background-size: cover;"></span>
                                </span>
                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="social_links.php?id=<?php echo $user['id']; ?>">
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-<?php echo $user['vk']; ?>"></i>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-<?php echo $user['telegram']; ?>"></i>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#E1306C">
                                        <i class="fab fa-<?php echo $user['instagram']; ?>"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
